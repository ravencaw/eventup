...
INSERT INTO eventos(nombre, descripcion, foto, organizador, ciudad, direccion, latitud, longitud, fecha, hora, precio, cantidad_entradas, usuario_id) VALUES ('Concierto Pablo Alborán', 'Concierto Tabú Benéfico', null, 'Sevilla', 'Sevilla', 'Camino de los Descubrimientos', '37.3992907', '-6.0072398', '2020-10-09', '20:15', 40.95, 300, 3);
INSERT INTO eventos(nombre, descripcion, foto, organizador, ciudad, direccion, latitud, longitud, fecha, hora, precio, cantidad_entradas, usuario_id) VALUES ('Concierto Juan Magan', 'Concierto presentación disco nuevo', null, 'Sevilla', 'Sevilla', 'Calle Juan Bautista Muñoz', '37.4101841', '-5.9998791', '2020-05-09', '20:15', 7.95, 300, 4);
INSERT INTO eventos(nombre, descripcion, foto, organizador, ciudad, direccion, latitud, longitud, fecha, hora, precio, cantidad_entradas, usuario_id) VALUES ('Weekend', 'Festival en Torre del Mar', null, 'Torre del Mar', 'Malaga', 'Calle Faro Nuevo, 5', '36.7320592', '-4.0997098', '2020-07-20', '12:15', 80.95, 300, 4);
INSERT INTO eventos(nombre, descripcion, foto, organizador, ciudad, direccion, latitud, longitud, fecha, hora, precio, cantidad_entradas, usuario_id) VALUES ('Festival flamenco', 'Festival de cante flamenco', null, 'Granada', 'Granada', 'Paseo de los Mártires, s/n', '37.172922', '-3.588128', '2020-05-09', '20:15', 7.95, 300, 5);
